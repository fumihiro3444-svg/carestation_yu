  ...
  const ssData = [
    {
      ...
      body: 'おひとりおひとりに寄り添い、安心できる毎日を共に歩みます。'
    },
    {
      tag: '居宅介護支援 ／ ヘルパーステーション',
      quote: '広がる空と大地に、ほっと息をつく。',
      body: '阿蘇の地に根ざし、笑顔あふれる暮らしを支えます。'
    },
    {
      tag: '居宅介護支援 ／ ヘルパーステーション',
      quote: '田植えの水面に、山々が宿る。',
      body: 'ケアプランの作成からヘルパー派遣まで、丁寧にサポートします。'
    },
    {
      tag: '居宅介護支援 ／ ヘルパーステーション',
      quote: '風にそよぐ草原が、今日を優しく包む。',
      body: '「今日もよかった」と感じていただける日々をお手伝いします。'
    },
    {
      tag: 'ケアステーションゆう　阿蘇市',
      quote: '新しい朝が、静かに、優しく始まります。',
      body: '住み慣れた地域で、自分らしく。ご家族と共に安心をお届けします。'
    }
  ];
